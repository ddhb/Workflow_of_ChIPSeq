# script 1 , Downloading sample data from Sequence Read Archive
library(SRAdb)
...
# script 3 , Alignment to reference genome 
library(QuasR)
library(BSgenome)
library(Rsamtools)
library(rtracklayer)
...
# script 4 , Qualityt check of aligned files
qQCReport(Aligned_control, "./QCreport_control.pdf")
qQCReport(Aligned_H3K4me3, "./QCreport_H3K4me3.pdf")

# script 5 , Constructing bin-level files from aligned read file
library("mosaics")
...
# script 6 , Reading bin-level data into the R enrivonment
